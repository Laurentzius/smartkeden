...
def test_customs_calculation_standard():
    ...
    # Customs Fee = 20,000 KZT (fixed)
    assert res.customs_fee_kzt == 20000.0
    ...
    # Import VAT = 595,000 * 12% = 71,400 KZT
    assert res.import_vat_kzt == 71400.0
    
    # Total Payments = 20,000 (Fee) + 50,000 (Duty) + 25,000 (Excise) + 71,400 (VAT) = 166,400 KZT
    assert res.total_payments_kzt == 166400.0
