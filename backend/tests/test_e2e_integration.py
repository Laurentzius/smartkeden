...
from app.core.documents.generator import DocumentGenerator, CustomsInvoiceSchema, InvoiceItemSchema, SupplyAgreementSchema
...
async def test_e2e_classification_calculation_generation(monkeypatch, tmp_path):
    ...
    result_invoice_path = DocumentGenerator.generate_invoice_excel(invoice_schema, invoice_path)
    result_contract_path = DocumentGenerator.generate_contract_word(contract_schema, contract_path)
