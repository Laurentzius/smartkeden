...
class Settings(BaseSettings):
    ...
    GOOGLE_CLOUD_PROJECT: str = os.getenv("GOOGLE_CLOUD_PROJECT", "project-432947fc-1170-4cc3-9fc")
    GOOGLE_CLOUD_LOCATION: str = os.getenv("GOOGLE_CLOUD_LOCATION", "global")
    GOOGLE_API_KEY: Optional[str] = os.getenv("GOOGLE_API_KEY") or os.getenv("GOOGLE_CLOUD_API_KEY")
    ...
    GEMINI_EMBEDDING_MODEL_ID: str = os.getenv("GEMINI_EMBEDDING_MODEL_ID", "gemini-embedding-2")
    USE_GEMINI_EMBEDDING: bool = os.getenv("USE_GEMINI_EMBEDDING", "False").lower() in ("true", "1", "yes")
    EMBEDDING_DIMENSION: int = int(os.getenv("EMBEDDING_DIMENSION", "384"))
    # Local Sentence‑Transformer model (primary embedding provider)
    EMBEDDING_MODEL_NAME: str = os.getenv("EMBEDDING_MODEL_NAME", "ibm-granite/granite-embedding-97m-multilingual-r2")
    ...
    LANGFUSE_ENABLED: bool = os.getenv("LANGFUSE_ENABLED", "True").lower() in ("true", "1", "yes")
